...
{/*                   <img src={githubIcon} alt="Visit site" /> </a> */}
            ...
            <div className="body">
              ...
              <p>
                Designed & developed an interactive E-Commerce web-application using Typescript, React, Redux, Redux toolkit, Redux-thunk, Axios, React Router, Framer Motion & Swiperjs having features such as Fully responsive, Add to cart, Delete from cart, Checkout, Lazy loading of images, Image optimization, Static footer containing a set of links, Quick View, Product Details, Cart & Login.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
{/*                 <a href="https://xbeat-rana.vercel.app/" target="\_blank" rel="noreferrer"> */}
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
{/*                 <a href="https://ranaportfolio-iota.vercel.app/" target="_blank" rel="noreferrer"> */}
{/*                   <img src={githubIcon} alt="Visit site" /> */}
{/*                  </a> */}
                <a href="https://ranaportfolio-iota.vercel.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>My Personal Typescript Portfolio Website</h3>
              <p>Developed my personal portfolio website using Typescript, CRA(Create React App) & Styled Components. This portfolio website is about myself, my skills, projects I have worked upon & my contact details.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Reactjs</li>
